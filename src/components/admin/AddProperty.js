...
class AddProperty extends Component{
    ...
    componentDidMount(){
      ...
      var config = {
          method: 'get',
          url: 'https://cuboidtechnologies.com/api/property/admin/get-all-similar-property-name',
          headers: {
    ...
    cat1=e=>{
        this.setState({cate1:true,cate2:false,cate3:false,cate4:false, step1:true,step2:false,step3:false, attributes:{}})
    }

    cat2=e=>{
        this.setState({cate1:false,cate2:true,cate3:false,cate4:false,step1:true,step2:false,step3:false, attributes:{}})
    }

    cat3=e=>{
        this.setState({cate1:false,cate2:false,cate3:true,cate4:false,step1:true,step2:false,step3:false, attributes:{}})    }

    cat4=e=>{
        this.setState({cate1:false,cate2:false,cate3:false,cate4:true,step1:true,step2:false,step3:false, attributes:{}})
    }
...
this.state.attributes.cost
        ...
        var config = {
            method: 'post',
            url: 'https://cuboidtechnologies.com/api/admin/house/post-house',
            headers: {
             Accept: 'application/json',
             Authorization: "Bearer " + localStorage.getItem("token"),  
            'content-type': 'application/json',
          ...
          .then( (response)=> {
            ...
            alert("Successfully Added House");
...
this.state.attributes.kmtoelectricity
        ...
        var config = {
            method: 'post',
            url: 'https://cuboidtechnologies.com/api/admin/land/post-land',
            headers: {
             Accept: 'application/json',
             Authorization: "Bearer " + localStorage.getItem("token"),  
            'content-type': 'application/json',
...
this.state.attributes.bedbreakfastcost
        ...
        var config = {
            method: 'post',
            url: 'https://cuboidtechnologies.com/api/admin/hotel/post-hotel',
            headers: {
             Accept: 'application/json',
             Authorization: "Bearer " + localStorage.getItem("token"),  
            'content-type': 'application/json',
...
this.state.attributes.kmfromtarmac
        ...
        var config = {
            method: 'post',
            url: 'https://cuboidtechnologies.com/api/admin/warehouse/post-warehouse',
            headers: {
             Accept: 'application/json',
             Authorization: "Bearer " + localStorage.getItem("token"),  
            'content-type': 'application/json',
    ...
    render() {
      ...
      if(this.state.AllProperty){
        ...
        return(<div className="tdb">{s[1]=="House"?<li>
        <input type="checkbox" onChange={this.checkboxChange(s[2])}/>
      <span>{s[0]}</span>
        ...
        SimilarLand= this.state.AllProperty.map(s=>{
          return(<div className="tdb">{s[1]=="Land"?<li>
         <input type="checkbox" onChange={this.checkboxChange(s[2])}/>
        <span>{s[0]}</span>
          ...
          SimilarHotel= this.state.AllProperty.map(s=>{
            return(<div className="tdb">{s[1]=="Hotel"?<li>
            <input type="checkbox" onChange={this.checkboxChange(s[2])}/>
          <span>{s[0]}</span>
            ...
            SimilarWare= this.state.AllProperty.map(s=>{
              return(<div className="tdb">{s[1]=="Warehouse"?<li>
              <input type="checkbox" onChange={this.checkboxChange(s[2])}/>
            <span>{s[0]}</span>
        ...
        return (<div>
          <NavbarAdmin class="zmdi zmdi-city" name="Add Property "/>
    ...
    Buy</label>
            ...
            <option value="House">House</option>
                   ...
                   {this.state.valiPropertyType?<div className='warning'>*Enter Property type</div>:""}
                    ...
                    <ul>
                    <li><input type="checkbox" name="opticalfiber" onChange={this.handleAttribute}/> OPTICAL FIBRE </li>
                    <li><input type="checkbox" name="cctv" onChange={this.handleAttribute}/> CCTV</li>
                    <li><input type="checkbox" name="swimmingpool" onChange={this.handleAttribute}/> SWIMMING POOL </li>
                    <li><input type="checkbox" name="borehole" onChange={this.handleAttribute}/> BORE HOLE </li>
                    <li><input type="checkbox" name="fireplace" onChange={this.handleAttribute}/> FIRE PLACE</li>
                    <li><input type="checkbox" name="disabilityfeature" onChange={this.handleAttribute}/> DISABILITY FEATURE</li>
                    <li><input type="checkbox" name="petsallowed" onChange={this.handleAttribute}/> PETS ALLOWED</li>
                    <li><input type="checkbox" name="maturegarden" onChange={this.handleAttribute}/> MATURE GARDEN</li>
                    <li><input type="checkbox" name="solarhotwater" onChange={this.handleAttribute}/> SOLAR HOT WATER</li>
                    <li><input type="checkbox" name="balcony" onChange={this.handleAttribute}/> BALCONY</li>
                    <li><input type="checkbox" name="waterfront" onChange={this.handleAttribute}/> WATER FRONT</li>
                    <li><input type="checkbox" name="partyarea" onChange={this.handleAttribute}/> PARTY AREA</li>
  ...
  <label>
    ...
    Agent</label>
                   ...
                   {this.state.valisellerLogo?<div className='warning'>*Enter seller Logo</div>:""}
                    ...
                    <input className="form-control" placeholder="Paste here" name="sellerNearestPlaceName" value={this.state.nearestPlaceName} onChange={this.handleChange}/>
                    ...
                    <input type="number" className="form-control" placeholder="Paste here" name="sellerNearestPlaceNameKm" value={this.state.nearestPlaceNameKm} onChange={this.handleChange}/>
...
<div className="row">
    <div className="col-md-6">
        <div className="form-group">
            <label>Cost</label>
            <input type="number" className="form-control" name="cost"  onChange={this.handleAttribute}/>
    ...
    <div className="col-md-6">
        <div className="form-group">
            ...
            <input className="form-control" name="sizeinacres"  onChange={this.handleAttribute} />
...
<div className="attributes">
    <ul>
        <li><input type="checkbox" name="freehold" onChange={this.handleAttribute}/> freehold</li>
        <li><input type="checkbox" name="lease" onChange={this.handleAttribute} /> lease</li>
        <li><input type="checkbox" name="councilwater" onChange={this.handleAttribute}/> council water</li>
        <li><input type="checkbox" name="electricity" onChange={this.handleAttribute}/> electricity</li>
        <li><input type="checkbox" name="borehole" onChange={this.handleAttribute} /> borehole</li>
        <li><input type="checkbox" name="readyfence" onChange={this.handleAttribute} /> readyfence</li>
        <li><input type="checkbox" name="gated" onChange={this.handleAttribute} /> gated</li>
        <li><input type="checkbox" name="waterfront" onChange={this.handleAttribute} /> waterfront</li>
        <li><input type="checkbox" name="controlleddevelopment" onChange={this.handleAttribute} /> controlleddevelopment</li>
    </ul>
</div>
...
<div className="numeric-number lookingd">
    <ul>
        <li>
            <div className="numeric-label"> <span>km to shopping center</span> <input name="kmtoshoppingcenter" type="number" onChange={this.handleAttribute}/></div>
            {!this.state.attributes.kmtoshoppingcenter && this.state.isAdd?<div className='warning'>* Required</div>:""}
        </li>
        <li>
            <div className="numeric-label"> <span>km to neighbour</span> <input  name="kmtoneighbour" type="number" onChange={this.handleAttribute}/></div>
            {!this.state.attributes.kmtoneighbour && this.state.isAdd?<div className='warning'>* Required</div>:""}
        </li>
        <li>
            <div className="numeric-label"> <span>km to tarmac</span> <input  name="kmtotarmac" type="number" onChange={this.handleAttribute}/></div>
            {!this.state.attributes.kmtotarmac && this.state.isAdd?<div className='warning'>* Required</div>:""}
        </li>
        <li>
            <div className="numeric-label"> <span>km to water</span> <input name="kmtowater" type="number" onChange={this.handleAttribute} /></div>
            {!this.state.attributes.kmtowater && this.state.isAdd?<div className='warning'>* Required</div>:""}
        </li>
        <li>
            <div className="numeric-label"> <span>km to electricity</span> <input name="kmtoelectricity" type="number" onChange={this.handleAttribute}/></div>
...
<div className="attributes">
  ...
  {!this.state.attributes.class?<div className='warning'>* Required</div>:""}
</div>
...
<div className="attributes">
  ...
  {!this.state.attributes.locality?<div className='warning'>* Required</div>:""}
</div>


  <div className="attributes">
    <ul>
      <li><input type="checkbox" name="carpark" onChange={this.handleAttribute}/> carpark</li>
      <li><input type="checkbox" name="spa" onChange={this.handleAttribute}/> spa</li>
      <li><input type="checkbox" name="aircon" onChange={this.handleAttribute}/> aircon</li>
      <li><input type="checkbox" name="freshoutdoors" onChange={this.handleAttribute}/> fresh out doors</li>
      <li><input type="checkbox" name="indoorpool" onChange={this.handleAttribute}/> indoor pool</li>
      <li>
        <input type="checkbox" name="disabilityaccess" onChange={this.handleAttribute}/> disability access
      </li>
      <li><input type="checkbox" name="barlounge" onChange={this.handleAttribute}/> Bar Lounge</li>
      <li><input type="checkbox" name="hairsalon" onChange={this.handleAttribute}/> Hair Salon</li>
      <li><input type="checkbox" name="petsallowed" onChange={this.handleAttribute}/> Pets Allowed</li>
    </ul>
  </div>
  <div className="numeric-number lookingd">
    <ul>
      <li>
        <div className="numeric-label">
          ...
          <input type="number" name="bedbreakfastcost" onChange={this.handleAttribute} />
        </div>
        {!this.state.attributes.bedbreakfastcost?<div className='warning'>* Required</div>:""}
      </li>
      <li>
        <div className="numeric-label">
          <span>km from tarmac</span>
          <input type="number" name="kmfromtarmac" onChange={this.handleAttribute} />
        </div>
        {!this.state.attributes.kmfromtarmac?<div className='warning'>* Required</div>:""}
      </li>
      <li>
        <div className="numeric-label">
          <span>Conference room</span>
          <input type="number" name="conferenceroom" onChange={this.handleAttribute}/>
        </div>
        {!this.state.attributes.conferenceroom?<div className='warning'>* Required</div>:""}
      </li>
      <li>
        <div className="numeric-label">
          <span>Cost</span>
        ...
        {!this.state.attributes.cost?<div className='warning'>* Required</div>:""}
      </li>
...
<div className="attributes">
  ...
  <div className="numeric-number lookingd">
    <ul>
      <li>
        <div className="numeric-label">
          <span>Area</span> <input type="number" name="area" onChange={this.handleAttribute}/>
        </div>
      ...
      <li>
        <div className="numeric-label">
          <span>Cost</span> <input type="number" name="cost" onChange={this.handleAttribute}/>
        </div>
        {!this.state.attributes.cost  && this.state.isAdd?<div className='warning'>* Required</div>:""}
      </li>
      <li>
        <div className="numeric-label">
          <span>Size in ft</span> <input type="number" name="sizeinfeet" onChange={this.handleAttribute}/>
        </div>
  ...
  <div className="attributes">
    <ul>
      <li>
        <input type="checkbox" name="conferencefacilites" onChange={this.handleAttribute} />
        conference facilites
      </li>
      <li>
        <input type="checkbox" name="freshoutdoors" onChange={this.handleAttribute} />
        freshout doors
      </li>
      <li>
        <input type="checkbox" name="aircon" onChange={this.handleAttribute}/>
        aircon
      </li>
      <li>
        <input type="checkbox" name="sharedsecretary" onChange={this.handleAttribute}/>
        shared secretary
      </li>
      <li>
        <input type="checkbox" name="fullyfurnished" onChange={this.handleAttribute}/>
        fully furnished
      </li>
      <li>
        <input type="checkbox" name="landscapegarden" onChange={this.handleAttribute}/>
        landscape garden
      </li>
      <li>
        <input type="checkbox" name="wifi" onChange={this.handleAttribute}/>
        wifi
      </li>
      {/* <!-- below 3  fields are extra --> */}
      
      <li>
        <input type="checkbox" name="indoorpool" onChange={this.handleAttribute}/>
        indoor pool
      </li>
      <li>
        <input type="checkbox" name="disabilityaccess" onChange={this.handleAttribute}/>
        disability access
      </li>
    </ul>
  </div>
