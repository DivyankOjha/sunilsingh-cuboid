...
class CreateFlipbook extends Component{
    ...
    constructor() {
		...
		this.state = {
            ...
            valilink360:false,
            valitempFloor:false,
            valitempFloorName:false,
            valifloorPlan:false,
            valiattributes:false,
            valiCatType:false
    ...
    addFloorPlan=e=>{
      if(this.state.tempFloorName==''){
        this.setState({valitempFloorName:true})
      }
      else{
        this.setState({valitempFloorName:false})

      }
      if(this.state.tempFloor==''){
        this.setState({valitempFloor:true})
      }
      else{
        this.setState({valitempFloor:false})

      }

      if(
        this.state.tempFloorName!=''
        &&
    ...
    onSubmit=e=>{
        ...
        const data={
          ...
          var config = {
            ...
            .then( (response) =>{
              console.log(response);
              alert("Successfully Added Flipbook");
...
<NavbarAdmin class="zmdi zmdi-map" name="Create Flipbook "/>
...
<select className="form-control" style={{width:'200px', display:'inline-block', marginLeft:'15px'}} onChange={this.selectChange}>
    <option>name</option>
    {AllPropertys}
</select>
</div>
{this.state.valiCatType?<div className='warning'>* select property name is Required</div>:""}
</div>
{this.state.loader?<div> <Spinner/> it may take a minute to upload images</div>:
<div className="tabbable-panel select-category">
				<div className="tabbable-line">
					...
					<div className="tab-content">
                        ...
                        <input type="text" className="form-control" placeholder="Enter title" name="title" onChange={this.handleChange} />
                        {this.state.valititle?<div className='warning'>*Enter Title</div>:""}
                        </div>  
                   

                        <div className="form-group"><label>Description</label>
                        <textarea className="form-control" placeholder="Type here" name="description" onChange={this.handleChange}></textarea>
...
spa
    ...
    petsallowed
                    ...
                    <div className="col-3 left">
                        <input type="text" className="form-control" placeholder="Lorem epsum sit dolor emit" name="link360" onChange={this.handleChange}/>
                    ...
                    <div className="form-group text-right"><button className="step-next" href="#tab_default_3" data-toggle="tab"  onClick={this.step3c} >Next</button></div>
                        ...
                        <div className="form-group"><label>Description</label>
                        <textarea className="form-control" placeholder="Type here" name="description2" onChange={this.handleChange}></textarea>
